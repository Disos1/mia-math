...
export const HASHBACHA_4: CurriculumUnit[] = [
  ...
  { id: 'numbers.addition',      strand: 'numbers', book: MIL, week: 6,  pages: [73, 85],   title: 'חיבור בתחום המיליון',                 skills: [] },
  { id: 'numbers.subtraction',   strand: 'numbers', book: MIL, week: 7,  pages: [86, 98],   title: 'חיסור בתחום המיליון',                 skills: [] },
  { id: 'numbers.add_sub_link',  strand: 'numbers', book: MIL, week: 8,  pages: [99, 112],  title: 'הקשר בין חיבור לחיסור והשפעת שינוי',  skills: [] },
  { id: 'numbers.order_ops',     strand: 'numbers', book: MIL, week: 9,  pages: [113, 125], title: 'סדר פעולות בחיבור וחיסור וסוגריים',   skills: [] },
  { id: 'numbers.word_problems', strand: 'numbers', book: MIL, week: 10, pages: [125, 137], title: 'בעיות מילוליות במספרים גדולים',       skills: [] },
  { id: 'numbers.negative',      strand: 'numbers', book: MIL, week: 11, pages: [139, 150], title: 'מספרים שליליים',                      skills: [] },
  { id: 'numbers.diagrams',      strand: 'numbers', book: MIL, week: 12, pages: [151, 165], title: 'דיאגרמות',                            skills: [] },
  { id: 'numbers.probability',   strand: 'numbers', book: MIL, week: 13, pages: [166, 180], title: 'ניתוח סיכויים',                       skills: [] },
  { id: 'numbers.gematria',      strand: 'numbers', book: MIL, week: 15, pages: [181, 192], title: 'שיטת א"ב העברי וגימטריה',            skills: [] },
  // ── Numbers continued: כפל וחילוק (≈33 h, Jan → Jun) ─────────────────────
  { id: 'numbers.mult_round',    strand: 'numbers', book: MD,  week: 16, pages: [7, 40],    title: 'כפל וחילוק בעשרות, מאות ואלפים שלמים', skills: [] },
  { id: 'numbers.mult_div_link', strand: 'numbers', book: MD,  week: 20, pages: [41, 58],   title: 'הקשר בין כפל לחילוק וסוגריים',        skills: [] },
  { id: 'numbers.mult_vertical', strand: 'numbers', book: MD,  week: 23, pages: [67, 114],  title: 'כפל בגורם דו-ספרתי ובמאונך',          skills: [] },
  { id: 'numbers.div_one_digit', strand: 'numbers', book: MD,  week: 28, pages: [117, 127], title: 'חילוק במחלק חד-ספרתי',                skills: [] },
  { id: 'numbers.long_division', strand: 'numbers', book: MD,  week: 29, pages: [128, 154], title: 'חילוק ארוך',                          skills: [] },
  { id: 'numbers.divisibility',  strand: 'numbers', book: MD,  week: 32, pages: [155, 181], title: 'סימני התחלקות',                       skills: [] },
  { id: 'numbers.primes',        strand: 'numbers', book: MD,  week: 34, pages: [182, 214], title: 'ראשוניים, פריקים ופירוק לגורמים',     skills: [] },
  ...
  { id: 'fractions.whole',        strand: 'fractions', book: FR, week: 5,  pages: [29, 40],   title: 'הרכבת השלם והשוואה לפי השלמה ל-1', skills: [] },
  { id: 'fractions.improper',     strand: 'fractions', book: FR, week: 7,  pages: [41, 53],   title: 'שברים גדולים מ-1 ומספרים מעורבים', skills: [] },
  ...
  { id: 'fractions.add_sub_same', strand: 'fractions', book: FR, week: 11, pages: [69, 98],   title: 'חיבור וחיסור שברים בעלי מכנים שווים', skills: [] },
  { id: 'fractions.mixed_a',      strand: 'fractions', book: FR, week: 16, pages: [99, 108],  title: 'חיבור וחיסור מספרים מעורבים (א)',   skills: [] },
  { id: 'fractions.equivalent',   strand: 'fractions', book: FR, week: 18, pages: [111, 120], title: 'שמות שונים לשבר',                 skills: [] },
  { id: 'fractions.add_sub_diff', strand: 'fractions', book: FR, week: 20, pages: [121, 148], title: 'חיבור וחיסור שברים במכנים שונים',  skills: [] },
  ...
  { id: 'geometry.rect_square',  strand: 'geometry', book: GEO, week: 6,  pages: [31, 42],   title: 'מלבן וריבוע',                     skills: [] },
  { id: 'geometry.triangles',    strand: 'geometry', book: GEO, week: 8,  pages: [43, 58],   title: 'משולשים — צלעות וזוויות',         skills: [] },
  { id: 'geometry.length',       strand: 'geometry', book: GEO, week: 10, pages: [61, 69],   title: 'מידות אורך — מ"מ, ס"מ, מטר',     skills: ['MEAS_UNIT_CONVERT_CM'] },
  { id: 'geometry.perimeter',    strand: 'geometry', book: GEO, week: 12, pages: [70, 89],   title: 'היקף מצולע והיקף מלבן',           skills: [] },
  { id: 'geometry.area',         strand: 'geometry', book: GEO, week: 16, pages: [90, 122],  title: 'שטח בסמ"ר ובמ"ר',                skills: [] },
  { id: 'geometry.symmetry',     strand: 'geometry', book: GEO, week: 24, pages: [125, 145], title: 'סימטריה שיקופית וסיבובית',        skills: [] },
  { id: 'geometry.boxes',        strand: 'geometry', book: GEO, week: 28, pages: [146, 224], title: 'תיבות, נפח ולוח השנה',           skills: [] },
];
