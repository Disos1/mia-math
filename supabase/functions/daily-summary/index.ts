...
const SKILL_NAMES: Record<string, string> = {
  ...
  FRAC_COMPLETE_WHOLE:    'הרכבת השלם והשלמה ל-1',
  FRAC_IMPROPER:          'שברים גדולים מ-1 ומספרים מעורבים',
  FRAC_ADD_SUB_SAME:      'חיבור וחיסור שברים במכנים שווים',
  FRAC_MIXED_ADD_SUB:     'חיבור וחיסור מספרים מעורבים',
  FRAC_EQUIVALENT:        'שמות שונים לשבר',
  FRAC_ADD_SUB_DIFF:      'חיבור וחיסור שברים במכנים שונים',
  GEOM_RECT_SQUARE:       'מלבן וריבוע',
  GEOM_TRIANGLES:         'משולשים — צלעות וזוויות',
  GEOM_PERIMETER:         'היקף',
  GEOM_AREA:              'שטח',
  GEOM_SYMMETRY:          'סימטריה',
  GEOM_SOLIDS:            'תיבות ונפח',
  ARITH_ADD_SUB_LARGE:    'חיבור וחיסור בתחום המיליון',
  NUM_ADD_SUB_LINK:       'הקשר בין חיבור לחיסור',
  NUM_ORDER_OPS:          'סדר פעולות וסוגריים',
  NUM_WORD_LARGE:         'בעיות מילוליות במספרים גדולים',
  NUM_NEGATIVE:           'מספרים שליליים',
  DATA_DIAGRAMS:          'קריאת דיאגרמות',
  DATA_CHANCE:            'ניתוח סיכויים',
  NUM_GEMATRIA:           'גימטריה',
  MULT_BY_TENS:           'כפל וחילוק בעשרות ומאות שלמות',
  MULT_DIV_LINK:          'הקשר בין כפל לחילוק',
  ARITH_MULT_VERTICAL:    'כפל במאונך',
  DIV_ONE_DIGIT:          'חילוק במחלק חד-ספרתי',
  ARITH_DIV_LONG:         'חילוק ארוך',
  NUM_DIVISIBILITY:       'סימני התחלקות',
  NUM_PRIMES:             'ראשוניים ופירוק לגורמים',
...
const ERROR_NAMES: Record<string, string> = {
  ...
  ERR_ADD_DENOMINATORS:   'חיבור המכנים זה לזה',
  ERR_PERIM_AREA_SWAP:    'בלבול בין היקף לשטח',
  ERR_ORDER_OPS:          'התעלמות מהסוגריים',
  ERR_ZERO_COUNT:         'אפס חסר בכפל בעשרות',
  ERR_MULT_PLACEHOLDER:   'כפל במאונך בלי האפס השומר',
};
